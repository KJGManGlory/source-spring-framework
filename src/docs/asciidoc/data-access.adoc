...
synchronization of the resources, and exception mapping. Thus, message data access code does
...
----
	<bean id="dataSource" class="com.mchange.v2.c3p0.ComboPooledDataSource" destroy-method="close">
		...
		<property name="message" value="${jdbc.username}"/>
		<property name="password" value="${jdbc.password}"/>
	</bean>
...
The following example shows returning the value of an Oracle `STRUCT` object of the message
...
a JPA message, the https://spring.io/guides/gs/accessing-data-jpa/[Getting Started Accessing
